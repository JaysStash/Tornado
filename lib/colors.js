...
// DAT's damage points/lines/polygons use a string efscale field
// ("EF0".."EF5", or unrated) rather than the numeric ef_rating this
// site's historical tornado data uses - same color values, different
// input shape, kept as its own expression rather than trying to share
// EF_MATCH_EXPRESSION across two different property types.
export const DAT_EFSCALE_MATCH_EXPRESSION = [
  "match",
  ["upcase", ["coalesce", ["get", "efscale"], ""]],
  "EF0", EF_COLORS[0],
  "EF1", EF_COLORS[1],
  "EF2", EF_COLORS[2],
  "EF3", EF_COLORS[3],
